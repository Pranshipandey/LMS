...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference("Library.count") do
      post libraries_url, params: { library: { book_count: @library.book_count, issued_at: @library.issued_at, mname: @library.mname, role: @library.role, titile: @library.titile } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { book_count: @library.book_count, issued_at: @library.issued_at, mname: @library.mname, role: @library.role, titile: @library.titile } }
