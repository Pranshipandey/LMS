...
class LibrariesTest < ApplicationSystemTestCase
  ...
  test "should create library" do
    ...
    fill_in "Book count", with: @library.book_count
    fill_in "Issued at", with: @library.issued_at
    fill_in "Mname", with: @library.mname
    fill_in "Role", with: @library.role
    fill_in "Titile", with: @library.titile
